                ...
                <div className="bootstrap__tableTwo">
                    <div className="bootstrap__tableTwoLeft">
                        ...
                        <div className="bootstrap__tableTwoLeftInfo">
                            ...
                            <p className="bootstrap__tableText marginBottom">
                                Sometimes when you have no extra time to arrange an advertising company scheduled for
                                “yesterday”, fast yet effective solutions should be used. With a Tilda solution we have
                    ...
                    <div className="bootstrap__tableTwoLeft">
                        ...
                        <div className="bootstrap__tableTwoLeftInfo">
                            ...
                            <p className="bootstrap__tableText marginBottom">
                                ...
                                responsibility for the full scale of works including Web Design and Web SaaS which is
                                mirroring an app`s functionality. We have also integrated a new Delivery service that
                ...
                <div className="bootstrap__tableTwo">
                    <div className="bootstrap__tableTwoLeft">
                        ...
                        <div className="bootstrap__tableTwoLeftInfo">
                            ...
                            <p className="bootstrap__tableText marginBottom">
                                A lot of people in the world want to support charity organizations, however, not all of
                                them have money for that. What if to convert CTP into money that could be donated to a
                                selected charity organization? What if to create a digital solution to make good things
                                trendy? CharyTime is a unique app that allows you to “donate your time”. NMS Team made a
                                new version of the application with extra features including new web SaaS and Landing
                                Page.
                            </p>
                            <h3 className="bootstrap__tableTwoTitle">
                                Tech Picture
